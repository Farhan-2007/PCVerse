...
with app.app_context():
    ...
    cpu = Category.query.filter_by(name="CPU").first()
    gpu = Category.query.filter_by(name="GPU").first()
    motherboard = Category.query.filter_by(name="Motherboard").first()
    ram = Category.query.filter_by(name="RAM").first()
    ssd = Category.query.filter_by(name="SSD").first()
    psu = Category.query.filter_by(name="Power Supply").first()
    cabinet = Category.query.filter_by(name="Cabinet").first()
    cooler = Category.query.filter_by(name="CPU Cooler").first()
    monitor = Category.query.filter_by(name="Monitor").first()
    keyboard = Category.query.filter_by(name="Keyboard").first()
    mouse = Category.query.filter_by(name="Mouse").first()
    ...
    print("PCVerse products inserted successfully!")